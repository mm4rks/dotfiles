---
name: humanizer
description: Remove signs of AI-generated writing from text. Use when editing or reviewing drafts that sound artificial, generic, or assembled.
...
If the draft is subtle, long, or high-stakes, read `references/patterns.md` before rewriting so you can audit against the full catalog instead of just the summary below.
