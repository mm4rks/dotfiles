...
install_base_deps() {
    ...
    local CORE_PKGS=(
        ca-certificates curl gnupg unzip git build-essential stow wget
        libfuse2 pipx libssl-dev zlib1g-dev libbz2-dev libreadline-dev
        ...
        python3-dev tmux bat libatomic1 poppler-utils qpdf pandoc binwalk
    )
